...
description: Legacy usage documentation for the Aetheris project, providing usage guidance for earlier versions
outline: deep
---

# Aetheris Usage Guide (Please Read Carefully)
...
conda create -n Aetheris python=3.12
