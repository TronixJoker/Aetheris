...
Aetheris provides comprehensive global keyboard shortcut support, allowing quick operations even when running in the background. The shortcut system is implemented with the pynput library and supports cross-platform use.
