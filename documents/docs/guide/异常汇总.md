...
```
(.venv) huangjunsen@huangjunsendeMac-mini Aetheris % pip install -r requirements_mac.txt -i https://pypi.tuna.tsinghua.edu.cn/simple
...
### **Error Description**
```
(.venv) apple@appledeMac-mini Aetheris % python main.py

Traceback (most recent call last):
  File "/Users/apple/Desktop/Aetheris/main.py", line 5, in <module>
    from src.application import Application
  File "/Users/apple/Desktop/Aetheris/src/application.py", line 23, in <module>
    from src.display import gui_display, cli_display
  File "/Users/apple/Desktop/Aetheris/src/display/gui_display.py", line 2, in <module>
...
```
Found opus library file: D:\xiaozhi\PC\Aetheris-main\libs\windows\opus.dll
Added DLL search path: D:\xiaozhi\PC\Aetheris-main\libs\windows
Successfully loaded opus.dll: D:\xiaozhi\PC\Aetheris-main\libs\windows\opus.dll
