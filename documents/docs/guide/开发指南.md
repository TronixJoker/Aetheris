# Aetheris Secondary Development Guide

> This document is intended for developers who wish to extend Aetheris with new features, develop plugins, or customize the UI.
...
Plugins are the core way to extend Aetheris's functionality. By inheriting from the `Plugin` base class, you can:
...
Aetheris's GUI uses the **PySide6 + QML (QtQuick)** architecture, following the MVVM pattern.
