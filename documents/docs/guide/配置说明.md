...
Aetheris's configuration files are stored in the **user data directory** (not the project root), following each platform's conventions:

| Platform     | Configuration Directory                                         |
|--------------|-----------------------------------------------------------------|
| **Windows**  | `C:\Users\<username>\AppData\Local\Aetheris\config\`          |
| **macOS**    | `~/Library/Application Support/Aetheris/config/`              |
| **Linux**    | `~/.local/share/Aetheris/config/`                             |
...
```bash
# macOS
open ~/Library/Application\ Support/Aetheris/config/

# Linux
xdg-open ~/.local/share/Aetheris/config/

# Windows (enter in File Explorer address bar)
%LOCALAPPDATA%\Aetheris\config
```
...
# macOS/Linux example:
rm ~/Library/Application\ Support/Aetheris/config/config.json
python main.py
```
...
```bash
# macOS/Linux example:
CONFIG_DIR=~/Library/Application\ Support/Aetheris/config
